...
<template>
  ...
  >
    <SheetContent
      ...
      :side="placement"
      :z-index="zIndex"
      :aria-describedby="description || descriptionFallback ? undefined : null"
    ...
    >
      ...
      >
        ...
        <VisuallyHidden v-if="!title || (!description && descriptionFallback)">
          <SheetTitle v-if="!title" />
          <SheetDescription v-if="!description && descriptionFallback" />
        </VisuallyHidden>
      ...
      <template v-else>
        <VisuallyHidden>
          <SheetTitle />
          <SheetDescription v-if="descriptionFallback" />
        </VisuallyHidden>
      </template>
      <div
        ref="wrapperRef"
